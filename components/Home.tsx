...
import { anim, txt1, txt1_1, txt2, txt2_1 } from "@/data/data";
    ...
    <div className="text-center text-[#184CD7] overflow-hidden  FontSHK_Dzeragir ">
      ...
      >
        <div className="flex items-center justify-center">
          <h2 className="text-[64px] mb-20 text-vrayi">Հայկ</h2>
          <span className="text-9xl text-taki"> & </span>
          <h2 className="text-[64px] mt-20 text-vrayi">Վիկա</h2>
        </div>
        <p className="FontSHK_Dzeragir text-[64px] text-vrayi">05/06/2026</p>
      </div>
      ...
      <div className=" mt-30 relative w-full text-[#184CD7] ">
